...
if (!DevExpress.MOD_VIZ_RANGESELECTOR) {
    ...
    (function($, DX, undefined) {
        ...
        rangeSelector.RangeSelector = core.BaseWidget.inherit(function() {
            ...
            var createSeriesDataSource = function(that) {
                    ...
                    checkLogarithmicOptions(chartOptions.valueAxis, defaultRangeSelectorOptions.chart.valueAxis.logarithmBase, that._incidentOccured);
                    if (dataSource || that.option('chart').series)
            ...
            var calculateTranslatorRange = function(that, seriesDataSource, scaleOptions) {
                    ...
                    translatorRange.arg.addRange({base: scaleOptions.logarithmBase});
            ...
            var checkLogarithmicOptions = function(options, defaultOptions, incidentOccured) {
                    if (options.type === 'logarithmic' && options.logarithmBase <= 0 || options.logarithmBase && !$.isNumeric(options.logarithmBase)) {
                        options.logarithmBase = defaultOptions;
            ...
            var prepareChartThemeOptions = function(that, options) {
                    var chartTheme;
                    if (!that.option('chart').theme && options && options.theme) {
                        ...
                        if (chartTheme) {
                            ...
                            that.option('chart').theme = chartTheme
                        }
                    }
                };
            ...
            return {
                    ...
                    _defaultOptions: function() {
                        return $.extend(true, this.callBase(), defaultRangeSelectorOptions)
                    },
    ...
    (function($, DX, undefined) {
        ...
        rangeSelector.RangeView = rangeSelector.BaseVisualElement.inherit(function() {
            var createThemeManager = function(that) {
                    return DX.viz.charts.factory.createThemeManager(that.chart.theme)
                };
        ...
        rangeSelector.SeriesDataSource = DX.Class.inherit(function() {
            ...
            var prototypeObject = {
                    ctor: function(options) {
                        ...
                        that._valueAxis = options.chart.valueAxis || {};
                        that._hideChart = false;
                        that._themeManager = createThemeManager(options.chart);
                        seriesTemplate = that._themeManager.getOptions('seriesTemplate');
                        ...
                        that._seriesFamilies = processSeriesFamilies(that._series, options.chart.equalBarWidth, options.chart.minBubbleSize, options.chart.maxBubbleSize)
                    },
                    ...
                    getBoundRange: function() {
                        ...
                        if (valRange.isDefined() && argRange.isDefined()) {
                            ...
                            valRange.applyEqualLimitsMargins()
                        }
                        return {
                                arg: argRange,
                                val: valRange
